          ...
          return (
            ...
            >
              ...
              >
                ...
                {tableData && <ChatTable data={tableData} />}
                ...
                {msg.sql_generated && (
                  <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-xs font-mono overflow-x-auto text-gray-700 dark:text-gray-300">
                    <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider font-sans">
                      Generated SQL
                    </div>
                    {msg.sql_generated}
                  </div>
      ...
      <div className="p-4 bg-white dark:bg-gray-800 border-t dark:border-gray-700">
        <form onSubmit={handleSubmit} className="flex gap-2 relative">
          ...
          >
            <Send
              size={18}
              className={`${loading ? "opacity-50" : "opacity-100"} ml-1`}
            />
          </Button>
        </form>
      </div>
