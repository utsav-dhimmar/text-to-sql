...
print("Connecting with:", DB_CONFIG["host"], DB_CONFIG["database"], DB_CONFIG["user"], DB_CONFIG["password"])
...
def save_chat(user_id: str, human_query: str, sql_generated: str, result_summary: str) -> dict:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"   Already exists — fetching instead")
        conn = get_conn()
        cur  = conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor)
